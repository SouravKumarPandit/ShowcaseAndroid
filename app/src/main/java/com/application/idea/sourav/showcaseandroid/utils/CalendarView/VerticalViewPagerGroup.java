 ...
 */
public class VerticalViewPagerGroup extends ViewGroup {
    ...
    public VerticalViewPagerGroup(Context context) {
        super(context);
        initViewPager();
    }

    public VerticalViewPagerGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
